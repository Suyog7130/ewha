# Part 2 — Calling Native Waveform Implementations (Tutorial + Notebook)
...
- pySEOBNR v5: SEOBNRv5HM / SEOBNRv5PHM / SEOBNRv5EHM.
- TEOBResumS via EOBRun Python bindings.
- GWSurrogate: NRSur7dq4, NRHybSur3dq8.

It also benchmarks generation time across families for `n=6` random draws per model.
